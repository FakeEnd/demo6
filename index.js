...
var activities_tab_cut =activities_tab.getElementsByTagName('div')
...
console.log(activities_tab_cut)
for (i = 0; i < length; i++) {
    ...
    activities_tab_li[i].onclick = function () {
        ...
        if (this.index==0) {
            activities_tab_cut[1].className='activities-cut-hide';
            activities_tab_cut[2].className='activities-cut';
        }
        if (this.index==1) {
            activities_tab_cut[1].className='activities-cut-hide';
            activities_tab_cut[2].className='activities-cut-hide'
        }
        if (this.index==2) {
            activities_tab_cut[2].className='activities-cut-hide';
            activities_tab_cut[1].className='activities-cut'
        }
    }
}
